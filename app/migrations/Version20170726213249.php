 ...
 */
class Version20170726213249 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE users_clients (user_id INTEGER NOT NULL, client_id INTEGER NOT NULL, PRIMARY KEY(user_id, client_id))');
        $this->addSql('CREATE INDEX IDX_F0C85ABEA76ED395 ON users_clients (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F0C85ABE19EB6921 ON users_clients (client_id)');
